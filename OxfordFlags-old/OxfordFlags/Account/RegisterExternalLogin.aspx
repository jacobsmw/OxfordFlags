<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="OxfordFlags.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="OxfordFlags" %>
