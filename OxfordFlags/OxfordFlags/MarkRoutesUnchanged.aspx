...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:Button ID="YesButton" runat="server" Text="Yes" CssClass="btn btn-default" />
    <asp:Button ID="NoButton" runat="server" Text="No" PostBackUrl="~/Admin.aspx" CssClass="btn btn-default" />
