<%@ Page Title="GPS Output" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GPSOutput.aspx.vb" Inherits="OxfordFlags.GPSOutput" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        <asp:Button ID="GPSOutputSearchButton" runat="server" Text="Search" />
        <br />
